...
import inkedin_dark from './inkedin_dark.png';
import github_dark from './github_dark.png';
import leetcode_dark from './leetcode_dark.png';
export const assets = {
    user_image,
    code_icon,
    code_icon_dark,
...
export const serviceData = [
    ...
    { icon: assets.graphics_icon, title: 'Portfolio design', description: 'Creative design Portfolio with enhance visual communication...' },
]
